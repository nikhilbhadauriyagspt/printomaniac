...
export default function PrivacyPolicy() {
  const email = "info@printerclub.shop";
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forPrinter Club ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://printerclub.shop/">http://printerclub.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Printer Club is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://printerclub.shop/cookie-policy">https://printerclub.shop/cookie-policy</a>.</p>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://printerclub.shop/contact">https://printerclub.shop/contact</a>.</p>
      <h3>Appeals</h3>
