...
export default function ReturnPolicy() {
  return (
    ...
    >
      ...
      <p>
                 To return an item, please email customer service at <a href="mailto:info@printerbrother.shop">info@printerbrother.shop</a>.      </p>
      ...
      <div className="bg-slate-50 p-8 rounded-none border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-3">
                     <p className="flex items-center gap-3 text-blue-600 font-black tracking-tight">info@printerbrother.shop</p>          <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em]">Contact support for immediate assistance</p>
        </address>
      </div>
    </PolicyLayout>
  );
